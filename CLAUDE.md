...
- **New Projects**: For new applications (e.g., Quizlet Clone), always initialize a `PLAN.md` using the `planning` skill before writing the first test.
- **Project Context**: Load specific app requirements from `PLAN.md` into the active context at the start of each session.
